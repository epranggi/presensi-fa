...
export const NavbarAdmin = ({ user }) => {
    ...
    return (
        <nav className="bg-blue-100 shadow-md px-4 py-3 md:px-8 fixed w-full z-50">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-6 items-center">
                    <Link to="/dashboard-admin" className="text-gray-700 hover:text-blue-600 transition">Dashboard</Link>
                    <Link to="/profile" className="text-gray-700 hover:text-blue-600 transition">Account</Link>
                    <Link to="/presence-admin" className="text-gray-700 hover:text-blue-600 transition">Presensi</Link>
            ...
            {isOpen && (
                <div className="md:hidden mt-3 space-y-2 px-4">
                    <Link to="/dashboard-admin" className="block text-gray-700 hover:text-blue-600 transition">Dashboard</Link>
                    <Link to="/profile" className="block text-gray-700 hover:text-blue-600 transition">Account</Link>
                    <Link to="/presence-admin" className="block text-gray-700 hover:text-blue-600 transition">Presensi</Link>
